...
export default function FloatingContacts() {
  ...
  return (
    <div
      className={`floating-contacts ${visible ? "floating-contacts--visible" : ""}`}
      aria-hidden={!visible}
    >
      <a
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="floating-contacts__btn floating-contacts__btn--whatsapp"
        aria-label="WhatsApp"
      >
