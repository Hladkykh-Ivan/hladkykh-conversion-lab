...
export default function Template3() {
  ...
  return (
    <div className="template-3 template-3--blue">
      <div className="template-3__header">
        <div className="template-3__image-wrapper">
          <svg
            className="template-3__image"
            viewBox="0 0 160 160"
        ...
        <h3 className="template-3__title">Conversion Helper</h3>
      </div>

      <ul className="template-3__list">
        <li className="template-3__item">
          <span className="template-3__item-icon-wrapper">
            <svg className="template-3__item-icon" viewBox="0 0 24 24" fill="none">
              <path
          ...
          <p className="template-3__item-text">{card.items[0]}</p>
        </li>
        <li className="template-3__item">
          <span className="template-3__item-icon-wrapper">
            <svg className="template-3__item-icon" viewBox="0 0 24 24" fill="none">
          ...
          <p className="template-3__item-text">{card.items[1]}</p>
        </li>
        <li className="template-3__item">
          <span className="template-3__item-icon-wrapper">
            <svg className="template-3__item-icon" viewBox="0 0 24 24" fill="none">
          ...
          <p className="template-3__item-text">{card.items[2]}</p>
        </li>
        <li className="template-3__item">
          <span className="template-3__item-icon-wrapper">
            <svg className="template-3__item-icon" viewBox="0 0 24 24" fill="none">
          ...
          <p className="template-3__item-text">{card.items[3]}</p>
        </li>
      </ul>

      <div className="template-3__footer">
        <a
          href={CONTACTS.telegram}
          target="_blank"
          rel="noopener noreferrer"
          className="template-3__button"
          onClick={(e) => e.stopPropagation()}
        >
          <span className="template-3__button-text">{card.cta}</span>
          <svg className="template-3__button-icon" viewBox="0 0 56 56" fill="none">
            <path
        ...
        <p className="template-3__button-description">{card.ctaHint}</p>
      </div>
    </div>
  );
}
