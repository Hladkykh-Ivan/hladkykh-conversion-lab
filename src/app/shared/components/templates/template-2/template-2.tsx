...
export default function Template2() {
  ...
  return (
    <div className="template-2 template-2--purple">
      <div className="template-2__header">
        <div className="template-2__image-wrapper">
          <svg
            className="template-2__image"
            viewBox="0 0 160 160"
        ...
        <h3 className="template-2__title">Conversion Helper</h3>
      </div>

      <ul className="template-2__list">
        <li className="template-2__item">
          <span className="template-2__item-icon-wrapper">
            <svg className="template-2__item-icon" viewBox="0 0 24 24" fill="none">
              <path
          ...
          <p className="template-2__item-text">{card.items[0]}</p>
        </li>
        <li className="template-2__item">
          <span className="template-2__item-icon-wrapper">
            <svg className="template-2__item-icon" viewBox="0 0 24 24" fill="none">
          ...
          <p className="template-2__item-text">{card.items[1]}</p>
        </li>
        <li className="template-2__item">
          <span className="template-2__item-icon-wrapper">
            <svg className="template-2__item-icon" viewBox="0 0 24 24" fill="none">
          ...
          <p className="template-2__item-text">{card.items[2]}</p>
        </li>
        <li className="template-2__item">
          <span className="template-2__item-icon-wrapper">
            <svg className="template-2__item-icon" viewBox="0 0 24 24" fill="none">
          ...
          <p className="template-2__item-text">{card.items[3]}</p>
        </li>
      </ul>

      <div className="template-2__footer">
        <a
          href={CONTACTS.telegram}
          target="_blank"
          rel="noopener noreferrer"
          className="template-2__button"
          onClick={(e) => e.stopPropagation()}
        >
          <span className="template-2__button-text">{card.cta}</span>
          <svg className="template-2__button-icon" viewBox="0 0 56 56" fill="none">
            <path
        ...
        <p className="template-2__button-description">{card.ctaHint}</p>
      </div>
    </div>
  );
}
