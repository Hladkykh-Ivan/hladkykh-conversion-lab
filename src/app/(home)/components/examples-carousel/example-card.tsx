...
const ITEM_ICONS = [
  <svg key="0" className="example-card__item-icon" viewBox="0 0 24 24" fill="none">
    <path
  ...
  <svg key="1" className="example-card__item-icon" viewBox="0 0 24 24" fill="none">
  ...
  <svg key="2" className="example-card__item-icon" viewBox="0 0 24 24" fill="none">
    <path
  ...
  <svg key="3" className="example-card__item-icon" viewBox="0 0 24 24" fill="none">
...
export default function ExampleCard({
  ...
  return (
    <div
      className={`example-card example-card--${theme}`}
      data-theme={theme}
    >
      <div className="example-card__header">
        <div className="example-card__image-wrapper">
          <svg
        ...
        <h3 className="example-card__title">Conversion Helper</h3>
      </div>

      <ul className="example-card__list">
        {card.items.map((text, i) => (
          <li key={i} className="example-card__item">
            <span className="example-card__item-icon-wrapper">{ITEM_ICONS[i]}</span>
            <p className="example-card__item-text">{text}</p>
          </li>
        ))}
      </ul>
      ...
      <div className="example-card__footer">
        ...
        >
          <span className="example-card__button-text">{card.cta}</span>
          <svg
            className="example-card__button-icon"
            viewBox="0 0 56 56"
            fill="none"
          >
            <path
        ...
        <p className="example-card__button-description">{card.ctaHint}</p>
      </div>
    </div>
  );
}
